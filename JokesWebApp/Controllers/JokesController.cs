...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        // POST: Jokes/ShowFormResultados
        public async Task<IActionResult> ShowFormResultados(String SearchFrase)
        {
            
            return _context.Joke != null ?
                          View("Index", await _context.Joke.Where( j => j.JokePergunta.Contains(SearchFrase) ).ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.Joke'  is null.");
        ...
        public async Task<IActionResult> Create([Bind("Id,JokePergunta,JokeResposta")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokePergunta,JokeResposta")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
